...
const WriteReview = () => {
  ...
  // 콘텐츠 정보 로딩 중
  if (isLoading) {
    return <LoadingSpinner message="콘텐츠 정보를 불러오는 중..." className={styles.loading} />;
  }

  // 에러 발생
  if (error) {
    return <ErrorMessage message={error} className={styles.error} />;
  }
      ...
      <div className={styles.innerContainer}>
        ...
        <div className={styles.formContainer}>
          <div className={styles.formHeader}>
            <h2 className={styles.formTitle}>상세 리뷰</h2>
            <p className={styles.formSubtitle}>작품에 대한 깊이 있는 생각을 공유해주세요</p>
          </div>
