  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <p className={styles.subtitle}>최종 수정일: 2026-02-03</p>
      </header>
      ...
      <main>
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            이 약관은 GeekFlex(이하 &quot;회사&quot;라 합니다)가 제공하는 온라인 서비스(이하
            &quot;서비스&quot;라 합니다)의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>이 약관에서 사용하는 용어의 정의는 다음과 같습니다:</p>
          <ul className={styles.list}>
            <li className={styles.listItem}>
              &quot;서비스&quot;란 회사가 제공하는 영화 및 드라마 정보 제공, 커뮤니티 등의 온라인
              서비스를 의미합니다.
            </li>
            <li className={styles.listItem}>
              &quot;이용자&quot;란 이 약관에 따라 회사가 제공하는 서비스를 받는 회원 및 비회원을
              말합니다.
            </li>
            <li className={styles.listItem}>
            ...
            <li className={styles.listItem}>
              &quot;아이디(ID)&quot;란 회원의 식별과 서비스 이용을 위하여 회원이 정하고 회사가
              승인하는 문자와 숫자의 조합을 말합니다.
            </li>
            <li className={styles.listItem}>
              &quot;비밀번호&quot;란 회원이 부여받은 아이디와 일치된 회원임을 확인하고 회원의 권익
              보호를 위하여 회원이 정한 문자와 숫자의 조합을 말합니다.
            </li>
          </ul>
        </section>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>제5조 (서비스의 제공 및 변경)</h2>
          <p className={styles.text}>회사는 다음과 같은 서비스를 제공합니다:</p>
          <ul className={styles.list}>
            <li className={styles.listItem}>영화 및 드라마 정보 제공 서비스</li>
            <li className={styles.listItem}>커뮤니티 서비스</li>
            <li className={styles.listItem}>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>제6조 (서비스의 중단)</h2>
          <p className={styles.text}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>회원은 다음 행위를 하여서는 안 됩니다:</p>
          <ul className={styles.list}>
            <li className={styles.listItem}>신청 또는 변경 시 허위내용의 등록</li>
            <li className={styles.listItem}>타인의 정보 도용</li>
            <li className={styles.listItem}>회사가 게시한 정보의 변경</li>
            <li className={styles.listItem}>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>제8조 (개인정보보호)</h2>
          <p className={styles.text}>
            회사는 이용자의 개인정보 수집 시 서비스제공을 위하여 필요한 범위에서 최소한의 개인정보를
            수집합니다.
          </p>
          <p className={styles.text}>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>제9조 (면책조항)</h2>
          <p className={styles.text}>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>제10조 (준거법 및 관할법원)</h2>
          <p className={styles.text}>
