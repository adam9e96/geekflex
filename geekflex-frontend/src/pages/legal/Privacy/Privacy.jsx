  ...
  return (
    <div className={styles.container}>
      ...
      <main>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>2. 개인정보의 처리 및 보유기간</h2>
          <p className={styles.text}>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              회원 가입 및 관리: 회원 탈퇴 시까지 (단, 관계 법령 위반에 따른 수사·조사 등이 진행중인
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>3. 처리하는 개인정보의 항목</h2>
          <p className={styles.text}>GeekFlex는 다음의 개인정보 항목을 처리하고 있습니다:</p>
          <ul className={styles.list}>
            <li className={styles.listItem}>
              필수항목: 아이디, 비밀번호, 닉네임, 이메일, 생년월일
            </li>
            <li className={styles.listItem}>선택항목: 자기소개, 프로필 이미지</li>
            <li className={styles.listItem}>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li className={styles.listItem}>법령에 특별한 규정이 있는 경우</li>
            <li className={styles.listItem}>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>5. 개인정보처리의 위탁</h2>
          <p className={styles.text}>
            GeekFlex는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고
            있습니다.
          </p>
          <p className={styles.text}>현재 개인정보 처리업무를 위탁하고 있지 않습니다.</p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>개인정보 처리정지 요구권</li>
            <li className={styles.listItem}>개인정보 열람요구권</li>
            <li className={styles.listItem}>개인정보 정정·삭제요구권</li>
            <li className={styles.listItem}>개인정보 처리정지 요구권</li>
          </ul>
        </section>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>9. 개인정보 처리방침 변경</h2>
          <p className={styles.text}>
            이 개인정보 처리방침은 2026년 2월 3일부터 적용되며, 법령 및 방침에 따른 변경내용의 추가,
